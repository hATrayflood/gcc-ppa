...
Replaces: gcc`'PV`'TS-base (<< 4.2.1-5)
...
Architecture: any
Priority: PRI(optional)
Depends: gcj`'PV-base (= ${gcj:Version}), ${dep:gcj}, ${dep:libcdev}, gij`'PV (= ${gcj:Version}), libgcj`'GCJ_SO-dev (= ${gcj:Version}), libgcj`'GCJ_SO-jar (>= ${gcj:SoftVersion}), ${dep:ecj}, libgcj-bc, java-common, ${shlibs:Depends}
...
Conflicts: libgcj8
Replaces: libgcj8, libgcj8-awt (<< 4.2-20060817)
...
Suggests: ${pkg:gcjqt}
Replaces: libgcj8-awt-gtk (<< 4.2-20070210)
...
Package: lib32ffi`'FFI_SO-dbg
Section: libdevel
Architecture: any
Priority: PRI(extra)
Depends: gcc`'PV`'-base (= ${gcc:Version}), lib32ffi`'FFI_SO (= ${gcc:Version})
Description: Foreign Function Interface library runtime (debug symbols)
 A foreign function interface is the popular name for the interface that
 allows code written in one language to call code written in another
 language.
...
Package: lib64ffi`'FFI_SO-dbg
Section: libdevel
Architecture: any
Priority: PRI(extra)
Depends: gcc`'PV`'-base (= ${gcc:Version}), lib64ffi`'FFI_SO (= ${gcc:Version})
Description: Foreign Function Interface library runtime (debug symbols)
 A foreign function interface is the popular name for the interface that
 allows code written in one language to call code written in another
 language.
...
Conflicts: libstdc++5-dbg`'LS, libstdc++5-3.3-dbg`'LS, libstdc++6-dbg`'LS, libstdc++6-4.0-dbg`'LS, libstdc++6-4.1-dbg`'LS
...
',`')`'dnl
Conflicts: lib32stdc++6-dbg`'LS, lib32stdc++6-4.0-dbg`'LS, lib32stdc++6-4.1-dbg`'LS
Description: The GNU Standard C++ Library v3 (debugging files)`'ifdef(`TARGET)',` (TARGET)', `')
 This package contains the shared library of libstdc++ compiled with
 debugging symbols.
ifdef(`TARGET', `dnl
...
',`')`'dnl
Conflicts: lib64stdc++6-dbg`'LS, lib64stdc++6-4.0-dbg`'LS, lib64stdc++6-4.1-dbg`'LS
Description: The GNU Standard C++ Library v3 (debugging files)`'ifdef(`TARGET)',` (TARGET)', `')
 This package contains the shared library of libstdc++ compiled with
 debugging symbols.
ifdef(`TARGET', `dnl
...
Conflicts: gnat (<< 4.1), gnat-3.1, gnat-3.2, gnat-3.3, gnat-3.4, gnat-3.5, gnat-4.0, gnat-4.1
...
Conflicts: libphobos-4.1-dev (<< 0.25-4.1.2-17exp3)
